# Contributing to pull-fetch

First and foremost, thank you! We appreciate that you want to contribute to pull-fetch, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for pull-fetch**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for pull-fetch:

- star the [project](https://github.com/jamen/pull-fetch)
- tweet your support for pull-fetch
...
- **version**: please note the version of pull-fetch are you using
...
[so]: http://stackoverflow.com/questions/tagged/pull-fetch